...
public class FileEncoder {
	...
	public static void ONE_TIME_PAD(String input, String output, Random r) throws IOException {
        ...
        public static int ENCODE_FILE_TO_IMAGE(String input, String imageFile, String output, long seed) throws Exception{
        	...
        	//0 - lakes, 1 - stars
        	int autoImgType = RANDOM.nextInt(2);
        	...
        	for(int i=0;i<parts;i++){
	        	...
	        	if(origOutput.equals("-")){
	        		...
	        		String file;
	        		if(autoImgType==0)
	        			file = LAKES[RANDOM.nextInt(LAKES.length)];
	        		else
	        			file = STARS[RANDOM.nextInt(STARS.length)];
	        		do{
	            ...
	            if(img==null){
		            ...
		            if(autoImgType==0)
		            	...
		            	img = CREATE_IMAGE(width, height, STAR_SURFACE_RGB[0], STAR_SURFACE_RGB[1]+shade, STAR_SURFACE_RGB[2], null); //pri hviezdach tocit iba s GREEN
	        		/*
